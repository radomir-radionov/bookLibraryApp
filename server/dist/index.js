...
var _index = _interopRequireDefault(require("./database/postgres/index.js"));
...
// Middleware
app.use((0, _cors["default"])()).use((0, _koaBodyparser["default"])()).use(router.routes()).use(router.allowedMethods());
